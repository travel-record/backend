...
public class CommentController {
    ...
    public ApiResponse<CommentUpdateResponse> updateComment(@PathVariable("commentId") Long commentId, @RequestBody @Valid CommentUpdateRequest request, @CurrentUser UserContext userContext) {
